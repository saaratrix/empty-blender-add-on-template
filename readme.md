...
Alternatively `pip install fake-bpy-module-4.0`.
...
Example:
`mklink /D "C:\Program Files\Blender Foundation\Blender\4.0\scripts\addons\example-addon" "C:\Users\User\empty-blender-add-on-template\example-addon"`
